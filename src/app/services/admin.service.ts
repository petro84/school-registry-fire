...
export class AdminService {
  ...
  constructor(private fs: AngularFirestore, private fa: AngularFireAuth, private router: Router) {
  ...
  setUserData(user: any) {
    const userRef: AngularFirestoreDocument<any> = this.fs.doc(`admins/${user.uid}`);
    const data: Admin = {
      email: user.email
    };
